...
namespace ErpDiscountsSubSystemNetCore.Diagnostics
{
    public class SerilogMiddleware
    {
        ...
        static string GetPath(HttpContext httpContext) => httpContext.Features.Get<IHttpRequestFeature>()?.RawTarget ?? httpContext.Request.Path.ToString();
    }
}
